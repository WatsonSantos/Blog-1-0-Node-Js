...
const app = express()
const admin = require("./routes/admin")//importando a rota de admin
...
//Configurações
  ...
  //É crucial que esses dois fiquem debaixo da sessão
  ...
  //Middleware
      app.use((req, res, next)=>{
        ...
        //O req.user tem os dados do usuário logado
        next()
      })
  ...
  //Public
      //Estampos dizendo para o express que a pasta que está guardando todo o arquivo estático é a pasta public
